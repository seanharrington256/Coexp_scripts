...
setwd("/Users/harrington/Active_Research/Ecotone_genomics/GBS_Data/Coexp_dryad/stairwayplot2/filtered_vcf")


path_vcf <- "Dpunctatus_p123_v3_25missEAST_popsouth.vcf"
# path_vcf <- "Dpunctatus_p123_v3_25missEAST_popnorth.vcf"
# path_vcf <- "Dpunctatus_p123_v3_25missEAST_popcentral.vcf"
